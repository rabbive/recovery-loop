...
describe('synthetic evaluation', () => {
  it('is reproducible and covers at least 50 cases', () => {
    const first = runEvaluation(generateEvaluationCases(60, 42));
    const second = runEvaluation(generateEvaluationCases(60, 42));
